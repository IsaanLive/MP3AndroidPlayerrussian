...
import com.euroasia.ru.R;
import com.euroasia.ru.DownloadingActivity;
...
public class DownloadService extends Service {
	...
	public class DownloadFilesTask  extends AsyncTask<String, Void, Void> {
		...
		protected void onCancelled() {
			...
			regularNotif("Загрузка отменена","Отменено: "+filename,filename); 
		...
		protected void onPostExecute(Void result) {
			...
			if(fail == 1){
				regularNotif("Загрузка не удалась","Не удалась: "+filename,filename); 
				http--;
				...
				regularNotif("Загрузка завершена","Завершена: "+filename,filename); 
			}
		...
		public void ongoingNotif(String contentTitle, String tickerText, String contentText ){
			...
			notification.setLatestEventInfo(context, contentTitle, "Для просмотра щелкните здесь", contentIntent);
			notificationManager.notify(numberd+9, notification);
		}
